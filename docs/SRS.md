...
- **RNF10: Monitoreo de Red**: El sistema debe exponer un estado de salud (Health Check) que incluya la conectividad de los servidores MCP y el estado consolidado de los túneles activos (Cloudflare y/o ngrok).
